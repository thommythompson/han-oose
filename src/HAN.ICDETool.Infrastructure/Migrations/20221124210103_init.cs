        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Toevoeging = table.Column<string>(name: "_Toevoeging", type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AangemaaktDoorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseInrichting_Docent_AangemaaktDoorId",
                        column: x => x.AangemaaktDoorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Monday = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeoordelingVoorId = table.Column<int>(type: "int", nullable: false),
                    BeoordeeldDoorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Beoordeling", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Beoordeling_Docent_BeoordeeldDoorId",
                        column: x => x.BeoordeeldDoorId,
                        principalTable: "Docent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Beoordeling_Student_BeoordelingVoorId",
                        column: x => x.BeoordelingVoorId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Beoordeling_TentamenUitvoering_TentamenId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LesUitvoering_LesInrichting_LesInrichtingId",
                        column: x => x.LesInrichtingId,
                        principalTable: "LesInrichting",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beoordeling_BeoordeeldDoorId",
                table: "Beoordeling",
                column: "BeoordeeldDoorId");

            migrationBuilder.CreateIndex(
                name: "IX_Beoordeling_BeoordelingVoorId",
                table: "Beoordeling",
                column: "BeoordelingVoorId");

            migrationBuilder.CreateIndex(
                name: "IX_Beoordeling_TentamenId",
                table: "Beoordeling",
                column: "TentamenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInrichting_AangemaaktDoorId",
                table: "CourseInrichting",
                column: "AangemaaktDoorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LesUitvoering_LesInrichtingId",
                table: "LesUitvoering",
                column: "LesInrichtingId");
